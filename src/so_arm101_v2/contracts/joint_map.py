...
``measured_20260908b`` (``load_joint_map``; ``measured_20260907`` and
``measured_20260908`` kept as predecessors) uses the exact 4096 ticks/turn
...
KNOWN_JOINT_MAPS = ("legacy_affine_v1", "measured_20260907", "measured_20260908", "measured_20260908b")
_TWO_PI = 2.0 * np.pi
...
def load_joint_map(name: str = "measured_20260908b") -> JointMap:
